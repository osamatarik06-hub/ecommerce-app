...
// Handle Login Server Action (Moved to module scope to fix form action binding)
...
// Handle Logout Server Action (Moved to module scope)
...
export default async function AdminDashboard({
  ...
  // Security Check: If not logged in as admin, block entry completely
  ...
  async function updateOrder(formData: FormData) {
    ...
    if (formData.has('estimatedDelivery')) {
      dataToUpdate.estimatedDelivery = estimatedDelivery
        ? new Date(estimatedDelivery + ':00Z')
        : null;
    }
  ...
  const totalPages =
    Math.ceil(totalLiveOrders / pageSize) || 1;
  ...
  allLiveOrdersForExport.forEach((o: any) => {
    ...
    csvRows.push([
      ...
      o.email || '',
      `"${purchasedItems.replace(/"/g, '""')}"`,
      `"${(o.paypalTransactionId || 'No PayPal Tx ID').replace(/"/g, '""')}"`,
      ...
      >
        ...
        >
          <div>
            ...
            >
              Manage live customer orders, fulfillment,
              tracking, and store inventory.
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            >
              <a
                href={excelDataUri}
                download={`velvet-orders-${new Date()
                  .toISOString()
                  .slice(0, 10)}.csv`}
                style={{
                  background: '#22c55e',
            ...
            >
              <thead>
                ...
                >
                  ...
                  <th style={{ padding: '12px 16px' }}>Purchased Items</th>
                  <th style={{ padding: '12px 16px' }}>PayPal Transaction</th>
                  <th style={{ padding: '12px 16px' }}>Shipping Address</th>
                  <th style={{ padding: '12px 16px' }}>Amount</th>
                  <th style={{ padding: '12px 16px' }}>Status</th>
                  <th style={{ padding: '12px 16px' }}>Fulfillment & Actions</th>
                </tr>
              </thead>
                          ...
                          {order.paypalTransactionId ? (
                            <div>
                              <div
                                ...
                                title={order.paypalTransactionId}
                              >
                                {order.paypalTransactionId}
                              </div>
                              <div
        ...
        >
          ...
          >
            ...
            >
              Test & Webhook Simulation Orders (Resend / Example)
            </span>
